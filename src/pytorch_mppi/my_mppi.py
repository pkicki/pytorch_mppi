...
from pytorch_mppi.noises.lifted import LiftedMultivariateNormal
...
class MPPI:
    def __init__(self, env, horizon, num_samples, control_dim, state_dim, noise_sigma,
                 ...
                 noise_interpolate_nodes=None, max_noise_dot=None, sampling_freq=None, lambda_=1.0, device='cpu'):
        ...
        elif max_noise_dot is not None:
            assert sampling_freq is not None
            self.noise_dist = LiftedMultivariateNormal(self.noise_mu, sampling_freq, max_noise_dot, covariance_matrix=self.noise_sigma)
